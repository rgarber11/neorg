...
## [10.0.0](https://github.com/rgarber11/neorg/compare/v9.1.1...v10.0.0) (2024-11-19)


### ⚠ BREAKING CHANGES

* tangle files relative to norg file ([#1415](https://github.com/rgarber11/neorg/issues/1415))
...
* remove `ftdetect` file as Neorg is now natively recognized by Neovim ([#1083](https://github.com/rgarber11/neorg/issues/1083))
...
* add `&lt;LocalLeader&gt;cm` keybind for code block magnification ([c52c00f](https://github.com/rgarber11/neorg/commit/c52c00f72c85d3ca258de623e40e64c3e552185a))
* add `core.ui.calendar` to the default list of modules ([52a37e0](https://github.com/rgarber11/neorg/commit/52a37e01abe059c6431f744eab9f22626fb275c5))
...
* add descriptions to all Neorg keybinds ([a042515](https://github.com/rgarber11/neorg/commit/a042515bc832ecab6d47a18ffc2976ee72f4bc1b))
* add dotrepeat to all common commands ([6b49397](https://github.com/rgarber11/neorg/commit/6b49397f1e8bea2f19064012e392cd4b36e00d18))
...
* auto tangle ([#1413](https://github.com/rgarber11/neorg/issues/1413)) ([0f24e4a](https://github.com/rgarber11/neorg/commit/0f24e4a53b05328a0ae6496be9867ea5df7b7f40))
* automatically typed `module.required` dependencies ([#1537](https://github.com/rgarber11/neorg/issues/1537)) ([1985f2d](https://github.com/rgarber11/neorg/commit/1985f2d6f152622b0066f48ba8e39d157635dd38))
...
* **calendar-ui:** new mappings ([2a4081f](https://github.com/rgarber11/neorg/commit/2a4081fe89f8f264c672eff2ab88b79f91aa6898))
* **calendar-ui:** support count in keymappings ([6b4751c](https://github.com/rgarber11/neorg/commit/6b4751c2c486578c8a11dfd2f79dfd35cacaa5b8))
* **calendar:** even more keybinds + ; repeat ([a5c2624](https://github.com/rgarber11/neorg/commit/a5c2624bc41cb760c4689734b2c3c5a9f17e4c48))
* **calendar:** unify exit keybind to always be `q` instead of a mix of `q`/`&lt;Esc&gt;` ([582d7b6](https://github.com/rgarber11/neorg/commit/582d7b616d9bdb5e2bbcba4ebd0e82f7fb9130e0))
...
* **completion:** allow custom completion engines ([04d201d](https://github.com/rgarber11/neorg/commit/04d201d56857073efecf79a8be29fae45b57ebeb))
...
* **concealer:** properly display blockquotes, allow entities to set their own clear functions ([28bbefc](https://github.com/rgarber11/neorg/commit/28bbefcfce10a51d7d834c6b6c0f7229bc6b38e1))
...
* **docgen:** add default keybinds list ([d762f6d](https://github.com/rgarber11/neorg/commit/d762f6dd4cfc7f8337272582abf0459b4c85fe3b))
* **docgen:** add more links to sidebar ([5bef42a](https://github.com/rgarber11/neorg/commit/5bef42ab385e0d2da9e68a60e4ba484c583b9aa7))
* **esupports.hop:** Add tab drop as option for open_mode ([#1580](https://github.com/rgarber11/neorg/issues/1580)) ([c7ada78](https://github.com/rgarber11/neorg/commit/c7ada7881d7076a235b6323edcd81ae260affb41))
...
* **health:** check for keybind clashes in checkhealth ([bbe4243](https://github.com/rgarber11/neorg/commit/bbe42438a90afd25a5d52b843ebbcc19d8476cef))
...
* **intergrations.otter:** update to use otter 2.0 ([1347eeb](https://github.com/rgarber11/neorg/commit/1347eebc8a0116524f17a7c33240ae782efb974e))
* **introspector:** implement introspector customizability and improvements ([#1539](https://github.com/rgarber11/neorg/issues/1539)) ([fd11950](https://github.com/rgarber11/neorg/commit/fd11950048d111b837b9f615c5d023e79bd1af9a))
* keybind refactor, update core.itero to new changes ([3dd946a](https://github.com/rgarber11/neorg/commit/3dd946ae976ee45147a60eeb5174f0f951f04f94))
* **keybinds:** add `extend_preset` function ([4f09926](https://github.com/rgarber11/neorg/commit/4f0992643b42d544a442f6e1928bd5838e355bcd))
* **keybinds:** don't try to forcefully override user keys ([591b883](https://github.com/rgarber11/neorg/commit/591b8831587895b95cbce30ad5a30c53f01b882c))
* **keybinds:** split presets into norg and non-norg, move to buffer-local mappings instead ([113c21b](https://github.com/rgarber11/neorg/commit/113c21b2de4f68c150a5778ff754cdbbec04758f))
...
* support multi-line values in metagen ([#1514](https://github.com/rgarber11/neorg/issues/1514)) ([321c435](https://github.com/rgarber11/neorg/commit/321c435e96a738a32ba2376f7f8f27b401759236))
...
* **`:h neorg`:** remove `|example` blocks until parser is fixed ([a93190d](https://github.com/rgarber11/neorg/commit/a93190db5b804c7db7d2f8f4d1c7edf6414cbe39))
* `insert-date` not working in insert mode ([7af14b3](https://github.com/rgarber11/neorg/commit/7af14b30b6ce9321e5a399eb6eb491ad111b0cda))
...
* better formatting, properly handle complex keybind descriptions ([c087db0](https://github.com/rgarber11/neorg/commit/c087db0473b3d8363e31135ef42d1290994075e6))
...
* calendar not working with the latest breakages ([c659b09](https://github.com/rgarber11/neorg/commit/c659b0901bea4143667489ee2af4c78762fabc5c))
...
* **concealer:** don't overflow folds into other, non-norg files ([19e4bea](https://github.com/rgarber11/neorg/commit/19e4beabdcd6080ececbd5ffcb7ecb50b1590461))
...
* **concealer:** properly render quotes ([08277bb](https://github.com/rgarber11/neorg/commit/08277bb5cf1b310d2527adcb0d613a8625c7b3d3))
* **concealer:** quote and list rendering bugs ([e292cf5](https://github.com/rgarber11/neorg/commit/e292cf5f3d19a8066e13928ff00efece10915124))
...
* coq_nvim completion integration ([#1597](https://github.com/rgarber11/neorg/issues/1597)) ([488507b](https://github.com/rgarber11/neorg/commit/488507bb996f75ee29073f50dec32fa220867ca5))
...
* **docgen:** beautify keybind output in &lt;details&gt; tag ([7a9d54c](https://github.com/rgarber11/neorg/commit/7a9d54c3c81bb1c403b3591cbc3b0cf27949fc6b))
* **docgen:** better mnemonic rendering ([b3bf963](https://github.com/rgarber11/neorg/commit/b3bf9639d2ebc905f7a99197844bf6da0547a2c9))
* **docgen:** broken wiki ([e23d0d3](https://github.com/rgarber11/neorg/commit/e23d0d32ea11d13c9da67b841a809b6cfda02887))
* **docgen:** display keybind data in the form of a dropdown ([572de72](https://github.com/rgarber11/neorg/commit/572de724159fcf929f3feb125da72b25ccad7bd2))
* **docgen:** invalid github markdown ([75edcdc](https://github.com/rgarber11/neorg/commit/75edcdc68ba9ce4aae5f0df6543f9818c55c5206))
...
* don't suggest leading chars for file completions ([ba35900](https://github.com/rgarber11/neorg/commit/ba35900b21921c439e676b063a79c8fad914eac9))
...
* error in hasmapto() ([dfcc78a](https://github.com/rgarber11/neorg/commit/dfcc78a110051aaedef8c19b48fda486960e1089))
...
* feed keys without remaps ([ecf5f41](https://github.com/rgarber11/neorg/commit/ecf5f415c96cf7a12b74a8233b8f6d4ecc3779c4))
...
* improve startup time by removing pcall on every module load ([7d9bd33](https://github.com/rgarber11/neorg/commit/7d9bd33a176fa86c65030776eb9b45cdb729250b))
...
* intuitive default undone icon ([#1578](https://github.com/rgarber11/neorg/issues/1578)) ([13d1d54](https://github.com/rgarber11/neorg/commit/13d1d546684c83ba464adbf463a8a272c884e1e8))
...
* itero keybind not functioning, add fallback functions to core.keybinds ([cd950aa](https://github.com/rgarber11/neorg/commit/cd950aa89ae2125882b235b8e79afde13c90e1b1))
* **keybinds:** correctly get keymap opts ([4a2f5b2](https://github.com/rgarber11/neorg/commit/4a2f5b2104169883131646f27ffaeb6af324b05a))
* **keybinds:** fixed tempus insert date insert mode default keybind command ([87e55f3](https://github.com/rgarber11/neorg/commit/87e55f3727ad84ecc261f7236892f4dbec82efc1))
...
* make core.promo keybinds functional again ([8a48172](https://github.com/rgarber11/neorg/commit/8a48172e94854d364b3cb3ecd2940cbe84b2f7bd))
* mark core.links as internal ([22e7151](https://github.com/rgarber11/neorg/commit/22e7151f02559cea0320d02b57e59d2fb8294956))
* **metagen:** proper iteration on metadata fields ([#1518](https://github.com/rgarber11/neorg/issues/1518)) ([0306887](https://github.com/rgarber11/neorg/commit/0306887c0c6ea302e3a3fecbb36998793f4c27d5))
* Neorg return to most recent file ([e5e797e](https://github.com/rgarber11/neorg/commit/e5e797e6eddcb6efb1d2c3fc2612b31ad9a76cef))
...
* non-functional toggling of sublists ([#1492](https://github.com/rgarber11/neorg/issues/1492)) ([169495c](https://github.com/rgarber11/neorg/commit/169495ca3ed67f919589499d20fa89bfea9e4de4))
...
* **promo:** promote/demote range + keybinds ([a94d1e6](https://github.com/rgarber11/neorg/commit/a94d1e67f7df3a97c0f57894c107b70a54523a4d))
...
* properly error when failing to load module using `:Neorg module load` ([721fd28](https://github.com/rgarber11/neorg/commit/721fd28f39ba2cb0978e410bd9a7668f8c74ccca))
...
* remove `tree-sitter-norg` from the luarocks dependency list momentarily (delegate work to nvim-treesitter for the moment) ([4103d43](https://github.com/rgarber11/neorg/commit/4103d43898f0a612f1b702c5a6d2ef1e7fb76058))
* remove all references to `core.mode` ([53429c4](https://github.com/rgarber11/neorg/commit/53429c497bda64671c7161b3f59d4640415bf145))
...
* **return:** return causing early exit when paired with auto_toc.exit_nvim ([959b8a2](https://github.com/rgarber11/neorg/commit/959b8a20114c63097261cd1b48f2dacfbe4ccd5f))
* set global keybinds only once, set keys on filetype ([e00042a](https://github.com/rgarber11/neorg/commit/e00042af322802f4db38706c5eeee8e77145fe65))
* set keybinds for the appropriate buffer (fixes telescope issues) ([b49c214](https://github.com/rgarber11/neorg/commit/b49c214f72ba33d5d76a63f7d70da43c840dc1e2))
* **summary:** ordering and indentation of nested entries ([9279672](https://github.com/rgarber11/neorg/commit/9279672d2b97929fc52d1b182af754497dfd8d8a))
...
* tangle files relative to norg file ([#1415](https://github.com/rgarber11/neorg/issues/1415)) ([3c3b977](https://github.com/rgarber11/neorg/commit/3c3b977dff916aecf5b2d63747896691c70639df))
...
* **text-objects:** node selection inconsistencies ([99b3249](https://github.com/rgarber11/neorg/commit/99b32492b836b64a5ff4544d4c466496f0aec9bd))
...
* **ToC:** only try to open when still in norg buffer ([#1549](https://github.com/rgarber11/neorg/issues/1549)) ([88dbab5](https://github.com/rgarber11/neorg/commit/88dbab5325ce07092ab7a38b160bc8e988830524))
...
* **toc:** various fixes ([#1500](https://github.com/rgarber11/neorg/issues/1500)) ([83637f1](https://github.com/rgarber11/neorg/commit/83637f11295aaaa6db5b0a28d6db8ac727592759))
...
* weird tangle file path logic ([#1604](https://github.com/rgarber11/neorg/issues/1604)) ([993f077](https://github.com/rgarber11/neorg/commit/993f077f0bff8faa68dbdb89ad95f67116b8007a))
...
* make Neovim 0.10 a requirement for Neorg ([c916501](https://github.com/rgarber11/neorg/commit/c91650128130f05c79a2cf1e981a8d87b1f91113))
* migrate core.promo to new keybind system ([faad665](https://github.com/rgarber11/neorg/commit/faad665a8e9c32f9dceae613e7c4c2abdbda9585))
* move core.pivot to new keybind system ([0c1222b](https://github.com/rgarber11/neorg/commit/0c1222b4aa4faf21a76158fe8de1339700442e08))
* move esupports.hop to the new keybind schema ([cdfbe19](https://github.com/rgarber11/neorg/commit/cdfbe19125a5d71288ea5c28f7916f709ca57ddd))
* move qol.todo_items to new keybind API ([b71d8ba](https://github.com/rgarber11/neorg/commit/b71d8ba34c53a0a4d022cd72af90513029800b27))
* move rest of modules to new keybind system ([94b860b](https://github.com/rgarber11/neorg/commit/94b860b704bceb1180eb82443064e6530e001fae))
...
* remove `core.mode` ([49e8710](https://github.com/rgarber11/neorg/commit/49e8710b3c09b19d69fcce322769fcbbdc4e6f30))
* remove `ftdetect` file as Neorg is now natively recognized by Neovim ([#1083](https://github.com/rgarber11/neorg/issues/1083)) ([5c32056](https://github.com/rgarber11/neorg/commit/5c320566757d334ab255a287da960d961d7a9012))
* remove `traverse-link` and `traverse-heading` modes ([da3e062](https://github.com/rgarber11/neorg/commit/da3e0621e03ad33f62cdd2fa77ba02ffb1b52d2b))
* simplify code in preparation of lazy.nvim luarocks support ([12b7cf2](https://github.com/rgarber11/neorg/commit/12b7cf253e60f6ce8552e4498a1598c8b57acf66))
